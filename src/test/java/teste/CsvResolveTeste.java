...
public class CsvResolveTeste {
    ...
    public void validarCSV(){
        try {
            ...
            List<String[]> csvPadronizadoEsperado = Arrays.asList(
                ...
                new String[]{"01/11/2023", "0000", "21.1", "70.0", "81.0", "93.0", "110.0", "105.0", "19.9", "20.2", "19.9", "946.5", "946.8", "946.5", "2.7", "46.0", "4.4", "", "0.2"},
    ...
    public void criarRegistro(){
        ...
        assertEquals("temperaturaMedia", primeiroRegistro.getTipo());
        assertEquals(75.5, primeiroRegistro.getValor());
        assertTrue(primeiroRegistro.isSuspeito());

        assertEquals("umidadeMedia", segundoRegistro.getTipo());
        assertEquals(107.5, segundoRegistro.getValor());
        assertTrue(segundoRegistro.isSuspeito());

        assertEquals("temperaturaMedia", sextoRegistro.getTipo());
        assertEquals(21.0 , sextoRegistro.getValor());
        assertFalse(sextoRegistro.isSuspeito());
