        ...
        try {
            if (conn != null) {
                ...
                String sql = "INSERT INTO registro (data, hora, estacao, siglaCidade, tipo, valor, suspeito) VALUES " +
                    ...
                    "('2021-01-01', '01:00:00', '83726', 'SC', 'temperaturaMedia', 30.0, false)," +
                    ...
                    "('2021-01-01', '02:00:00', '83726', 'SC', 'chuva', 5.0, false)," +
                    "('2021-01-01', '02:00:00', '83726', 'SC', 'temperaturaMedia', 'NULL', false)," +
                    "('2021-01-01', '02:00:00', '83726', 'SC', 'umidadeMedia', 55.0, false)," +
                    "('2021-01-01', '02:00:00', '83726', 'SC', 'velVento', 10.0, false)," +
                    "('2021-01-01', '02:00:00', '83726', 'SC', 'dirVento', 190.0, false)," +
                    "('2021-01-01', '03:00:00', '83726', 'SC', 'chuva', 2.0, false)," +
