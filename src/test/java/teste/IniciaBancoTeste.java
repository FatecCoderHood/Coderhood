        ...
        try {
            if (conn != null) {
                ...
                String sql = "INSERT INTO registro (data, hora, estacao, siglaCidade, tipo, valor, suspeito) VALUES " +
                    ...
                    "('2021-01-01', '02:00:00', '83726', 'SC', 'temperaturaMedia', 38.0, false)," +
                    "('2021-01-01', '02:00:00', '83726', 'SC', 'umidadeMedia', 68.0, false)," +
                    "('2021-01-01', '02:00:00', '83726', 'SC', 'velVento', 11.0, false)," +
                    "('2021-01-01', '02:00:00', '83726', 'SC', 'dirVento', 121.0, false)," +
                    "('2021-01-01', '02:00:00', '83726', 'SC', 'chuva', 3.0, false)," +
                    "('2021-01-01', '03:00:00', '83726', 'SC', 'temperaturaMedia', 70.0, true)," +
                    "('2021-01-01', '03:00:00', '83726', 'SC', 'umidadeMedia', 110.0, true)," +
                    "('2021-01-01', '03:00:00', '83726', 'SC', 'velVento', 500.0, true)," +
                    "('2021-01-01', '03:00:00', '83726', 'SC', 'dirVento', 400.0, true)," +
                    "('2021-01-01', '03:00:00', '83726', 'SC', 'chuva', 900.0, true)," +
